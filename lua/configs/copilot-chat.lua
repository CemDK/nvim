return {
    ...
    sticky = "#filenames #buffer", -- Default sticky prompt or array of sticky prompts to use at start of every new chat.
    ...
    window = {
        ...
        width = 85, -- fractional width of parent, or absolute width in columns when > 1
